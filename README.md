...
|:------:|:-------------------------------------------------------------------------- |:-----------------------:|:-----------------------------------------:|
|   1    | Introducción a Python y Jupyter Notebooks                                  |	Agosto 9				|											|
|   2    | Gráficas y visualización (ajuste de datos, estadística, barras de error)   |	Agosto 14 y 16			|											|
|   3    | Interpolación (curva de una bomba)                                         |	Agosto 23				| T1 (Septiembre 3)  						|
|   4    | Raíces de ecuaciones (factor de fricción de Darcy)                         |	Agosto 28 y 30			|											|
|   5    | Sistemas de ecuaciones (estática, e.g., cerchas)                           |	Septiembre 4 y 6		| T2 (Septiembre 17)<br>P (Noviembre 1)		|
|   6    | Optimización (operación de sistema eólico y de bombeo)                     |	Septiembre 11 y 13		|											|
|   7    | ODEs (incertidumbre-propagación, dinámica)                                 |	Septiembre 18 y 20		| T3 (Noviembre 1)							|
|   8    | FFT (señales de péndulos y audio)                                          |	Septiembre 25 y 27		|											|
